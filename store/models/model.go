...
func init(){
	...
	//注册表
	orm.RegisterModel(new(User),new(Address),new(Goods),new(GoodsSKU),new(GoodsType),new(GoodsImage),new(IndexTypeGoodsBanner),new(IndexPromotionBanner),new(IndexGoodsBanner),new(OrderInfo),new(OrderGoods))
	//跑起来
